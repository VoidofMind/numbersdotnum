...
cls
echo "                                                     ................'''.......                                                                      "
echo "                                     ..''``^^",,:;;IIIII;;;;I;IIIIII;;I;;;;;;IIIIII:,,,"^````'...                                                    "
echo "                            .'``",:;;I;I;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;I;;;;II;:,,,"^`''.                         `^""``.        "
echo "                      ..`",;IIIIII;;I;;;;;;;;;;;;;;III;;;;;;;;;;;;II;:,,:I;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;III;:,^`'..            .^+?:^``^,!]i^.    "
echo "      .,:"`'...  .'^";I;;;;;;;;I..`'.':^^",^^"'.:;,''`.`":^^"I;;I":>>>>?~^I;;;;;;;;;;;;;;;;;I;I;;;;;;;;;;;;;;;;;;;;;II;,^`..   ''`~?'         .:1".  "
echo "     .^\'`":i1;`:II,,::,,,";;;;l ,'^'..'`` ``^'`I;I ,''^ ''``I;;I'/^   "t`I;;;III;;;;I;"":;;;;:,";I,,;;;;:",;;:";I:,",,;I;;I;"'^l}{    .":,`    .}!  "
echo "      ^/     '(?,^:'/,",,<|""I;I^"II^",``,,`^:"";;I^,"""":``,IIII'/^   "/,!<++iI,,II:";[i,`''`^;[i":\;^^^|[,^`[I^I+_++-~l:"^^:~ii\"    1}<~}}.   't` "
echo "      ^\      '|?>:"/.   `\<;^,;;;;;;;;III;;IIII;,"","":"";l!!l;"'/^   "["'   .`__^^;1"          ^({\`   ^    +|[`      '"?_,;<i>\l,"`,/+i!i\`    |; "
echo "      ^\       '(]>]/.   ^/-_?I,";I",:;;;::I!iii!]+!l>[>}<^'...^[i/^   .  ..     :|<1.   ;{(|}"   '\/`    ',:,})    ":"`   '1I,i!i<~+_?-<>>}}.    \: "
echo "      ^/    "`  '(]+/.   ^/I"""?1^^^\^^^`1\,...i`      "'       .)/^    ,}{})"    {\^   ^l;;:,,    +/`   "\+<<[{    ,~|/_.  '/^~<<<<+_+~-{},.    :\' "
echo "      ^/    "\`  .{1/.   ^/`   l(!;;\    }\^    '",`    .~)(-    ~/^   ^\~>>-/.   !/.        ......</`   >)~>ii)<'     '^l)(](^_?]]?-]11;'     .i)`  "
echo "      ^/    "/|`  .}/.   ^/`   l(!<[|    {\^   "\+-/.   !)i?/    </^   :\_-_?/.   -/'   I|){}|\--__|/`   >(+~i}[{({!"'.    `-_"{[?_[)l'     .^~},.   "
echo "      ^/    "\+\"  .?.   ^/`   l(!<[\    }/^   ;(i-/.   >1~[/    </^   '|)1{|"   '/|_    ^!<>:'   ^\\`   >(+>l(,   `\\\]:    ?+,<~(!.    ."_{:'      "
echo "      ^\    "\l+|"  ..   ^/`   l(!<[\    }/^   ;(i?/.   >1_1/    </^    .`"`.   ')[>{]`         `_)?\`   <(~>!~|"   .`,:,.   ;{`>(;    .!|/}I:,^``'  "
echo "     .^/    "\li_\,      ^/`   ,|<_(_    {\^   ;(i?/.   >1_)/    </^   ``    .`i(]_<i<]1-!;:;i-1}->i[{}}[1}+<>!>[}:`.       "\";[{          .''`^:/` "
echo "     .^\^'. "\li<-\;     ^/l    ";:^     {\^   ;(i]/.   >)_[/..'`]\_!<_{{{}}{{?_-}]-+~<>i><<<<~??_~<<>>+?[?-_~<>ii~-[{[?__]?I"I!(<'..            '/` "
echo "       ',i[11[!i<+?|l'.. ^/\,.     .,.   }\".''<(i?\!Ii~1]_;[}[??_<<<>><~<<<<+?I`11}[]?---?]+l){}[]]_"I|){}[?--_+~~<>>>:",,!~<i!<?][}1{[?_~!;:,^`,\' "
echo "           .`,i+~_-]1{}}{{]>])?~>~?1{}}{1{][[]?-<>-]+<>>><-",~++__???]][[[[[{?^. .^I-}{{?>,`.`lll!I`   ^+()1{{}[[]]i:;;~[?-__++~~~<<<>>>iii><~~iI:^  "
echo "               .`,<}11)["!+++___~>><<~~<~~~++++__-]1^~?]][{"'{{1){<>ll:"","^.                            .`^,:::,`..^!>+?[{{}}[[]]]]]?<;,^`'.        "
echo "                    .''.  .`:<+?}{;I]}{{1}{111?--+<!'.",,"^. ...                                                            ..''```'.                "
echo "                                    ..''.                                                                                                            "
timeout /t 3 /nobreak
cls
...
echo like you just received something special!
timeout /t 5 /nobreak
cls
echo Goodbye!
