...
timeout /t 2 /nobreak
cls
@echo Your Number is: %random%! & echo: ___________________________ & echo: The numbers you could have received were: & echo: %random%, & echo: %random%, & echo: or %random%! & echo: ___________________________ & echo: I hope you like your number! Have a good day! > YourNumber.txt
